...
if __name__ == "__main__":
    ...
    print(
        "R-1.6 sumOfSquaresOfOddNumberLessThan(10): "
        + str(sumOfSquaresOfOddNumberLessThan(10))
    )
    print(
        "R-1.7 sumOfSquaresOfOddNumberLessThanUsingComprehension(10): "
        + str(sumOfSquaresOfOddNumberLessThanUsingComprehension(10))
    )
    print("R-1.9 getArray [50,60,70,80]: ", [x for x in range(50, 90, 10)])
    print(
        "R-1.10 getArray [8, 6, 4, 2, 0, −2, −4, −6, −8]: ",
        [x for x in range(8, -10, -2)],
    )
    print(
        "R-1.11 getArray [1, 2, 4, 8, 16, 32, 64, 128, 256]: ",
        [pow(2, x) for x in range(0, 9)],
    )
    ...
    and in the python function we can use arr[::-1] """,
        arr[::-1],
    )
